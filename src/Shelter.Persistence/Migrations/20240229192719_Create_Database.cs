        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    security_deposit_amount = table.Column<decimal>(type: "numeric", nullable: false),
                    security_deposit_currency = table.Column<string>(type: "text", nullable: false),
                    last_booked_on_utc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    allowed_pet_sizes = table.Column<int[]>(type: "integer[]", nullable: false),
                    allowed_pet_types = table.Column<int[]>(type: "integer[]", nullable: false),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_pet_sitters", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    pet_sitter_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_bookings_pet_sitter_pet_sitter_id",
                        column: x => x.pet_sitter_id,
                        principalTable: "pet_sitters",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_reviews_pet_sitters_pet_sitter_id",
                        column: x => x.pet_sitter_id,
                        principalTable: "pet_sitters",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_bookings_pet_sitter_id",
                table: "bookings",
                column: "pet_sitter_id");
