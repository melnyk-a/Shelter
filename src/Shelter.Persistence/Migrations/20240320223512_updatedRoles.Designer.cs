...
namespace Shelter.Persistence.Migrations
{
    ...
    [Migration("20240320223512_updatedRoles")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shelter.BackgroundJobs.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Shelter.Domain.Users.RolePermission", b =>
                {
                    ...
                    b.HasIndex("PermissionId")
                        .HasDatabaseName("ix_role_permisions_permission_id");
            ...
            modelBuilder.Entity("Shelter.Domain.Users.RolePermission", b =>
                {
                    b.HasOne("Shelter.Domain.Users.Permission", null)
                        .WithMany()
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_role_permisions_permissions_permission_id");
                    ...
                    b.HasOne("Shelter.Domain.Users.Role", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_role_permisions_roles_role_id");
                });
